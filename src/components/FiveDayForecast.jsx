      ...
      <div className="grid grid-cols-[repeat(auto-fit,minmax(150px,1fr))] gap-5">
        {
          uniqueDays.map((day, index) => (
            <div key={index} className="bg-card-bg rounded-(--radius) px-4 py-5 text-center transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_8px_25px_rgba(0,0,0,0.15)] border border-borderColor">
